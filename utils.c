...
void ParseBootSector(void) {
  ...
  FAT_StartLoc = ThisFATSecNum*BPB_BytsPerSec;
  FAT_EndLoc = BPB_FATSz32 * BPB_BytsPerSec + FAT_StartLoc;
}
...
int FindFirstSectorOfCluster(int n) {
  ...
  int DirLocation = FirstSectorofCluster * BPB_BytsPerSec;
  return DirLocation;
}
